...
function About(props) {
	return (
		<div className="display-flex justify-center">
			<article className="ctr-color ctr-blue housing">
				...
				<section className="ctr-6 medium text-left">
					<p>
				...
				<section className="ctr-6 medium text-left">
					<h2 className="header-3 blue"> Vision: </h2>
					<p>
						<br/>
				...
				<section className="ctr-6 medium text-left">
					<h2 className="header-3 blue"> Mission: </h2>
					<p>
						<br/>
				...
				<section id="protect" className="ctr-6 medium text-left">
					<h2 className="header-3 blue"> Protecting vulnerable people: </h2>
						<p>
							<br/>
				...
				<section id="works" className="ctr-6 medium text-left">
